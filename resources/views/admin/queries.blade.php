  ...
  <div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-8 col-md-6 mb-4">
            <h1 class="h3 mb-2 text-gray-800">Queries / Feedback</h1>
            <p class="mb-4">Below is a list of all the queries and feedbacks received.</p>
        </div>
         <!-- Total Messages Card -->
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                Queries / Feedbacks</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{$queriesCount}}</div>
                        </div>
